...
## Introduction
In order to explore US Healthcare, I came to develop this project while learning several domains. Initially, I explored the US health care official sites to learn about what actaully is it and it's compliance. I joined foundational HIPAA training https://hipaatraining.us/ and studied HIPAA documentation from http://hhs.gov/
...
- ```architecture.png``` : Medallion architecture within databricks delta lakehouse
...
- I learnt about spark and several databricks features. I really like the version history of my tables which is really helpful to retrieve any versions of data.
